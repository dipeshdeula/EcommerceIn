        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2025, 5, 27, 10, 25, 17, 245, DateTimeKind.Utc).AddTicks(1116)),
                    ImageUrl = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDateTimeUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2025, 5, 27, 10, 25, 17, 249, DateTimeKind.Utc).AddTicks(2407)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slug = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    MarketPrice = table.Column<double>(type: "numeric(18,2)", nullable: false, defaultValue: 0.0),
                    CostPrice = table.Column<double>(type: "numeric(18,2)", nullable: false, defaultValue: 0.0),
                    DiscountPrice = table.Column<double>(type: "numeric(18,2)", nullable: true, defaultValue: 0.0),
